    ...
    <div class="card card-default card-profile">
      ...
      <div class="card-footer card-profile-footer">
        <ul class="nav nav-border-top justify-content-center">
          <li class="nav-item">
            <a class="nav-link active" href="user-profile-settings.html">Profile</a>
          </li>
        </ul>
      </div>
    </div>
          ...
          <div class="card-body">
            <div class="media media-sm">
              <div class="media-sm-wrapper">
                <img
                  src="{{asset('assets/images/user/user-sm-01.jpg')}}"
                  alt="User Image"
                />
              </div>
            ...
            <form>
              <div class="form-group row mb-6">
                ...
                <div class="col-sm-8 col-lg-10">
                  ...
                  <span class="d-block"
                    >Upload a new cover image, JPG 1200x300</span
                  >
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="d-flex mb-5">
                      <button
                        type="button"
                        class="btn btn-icon facebook mr-2"
                      >
                    ...
                    <div class="d-flex mb-5">
                      <button
                        type="button"
                        class="btn btn-icon google-plus mr-2"
                      >
                  ...
                  <div class="col-lg-6">
                    <div class="d-flex mb-5">
                      <button
                        type="button"
                        class="btn btn-icon twitter mr-2"
                      >
                    ...
                    <div class="d-flex mb-5">
                      <button
                        type="button"
                        class="btn btn-icon linkedin mr-2"
                      >
                    ...
                    <div class="d-flex mb-5">
                      <button
                        type="button"
                        class="btn btn-icon pinterest mr-2"
                      >
